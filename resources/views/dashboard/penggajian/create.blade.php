                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <span class="h5 m-0">Gaji {{ $user->name }}
                                            ...
                                            <form action="{{ route('penggajian.store') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="gaji_pokok"
                                                        name="gaji_pokok" value="{{ $gaji_pokok }}" readonly>
                                                </div>

                                                <div class="form-group">
                                                    <label for="tunjangan_jabatan">Tunjangan Jabatan</label>
                                                    <input type="number" class="form-control" id="tunjangan_jabatan"
                                                        name="tunjangan_jabatan" value="{{ $tunjangan_jabatan }}" readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="potongan_absensi"
                                                        name="potongan_absensi" value="{{ $potonganAbsensi }}">
                                                </div>
