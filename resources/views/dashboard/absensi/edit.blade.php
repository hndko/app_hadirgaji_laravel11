                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <span class="m-0 h5">Edit Setting Absensi</span>
                            <div class="card-tools">
                                <a href="{{ route('absensi-settings.index') }}" class="btn btn-sm btn-secondary">Kembali</a>
                            </div>
                        </div>
                        <form action="{{ route('absensi-settings.update', $setting->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                        name="jam_masuk" value="{{ old('jam_masuk', $setting->jam_masuk) }}">
                                    @error('jam_masuk')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('jam_pulang') is-invalid @enderror"
                                        name="jam_pulang" value="{{ old('jam_pulang', $setting->jam_pulang) }}">
                                    @error('jam_pulang')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('toleransi_keterlambatan', $setting->toleransi_keterlambatan) }}"
